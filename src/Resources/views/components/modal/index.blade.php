            ...
            >
                ...
                >
                    <div class="flex min-h-full items-end justify-center p-4 sm:items-center sm:p-0">
                        <div class="box-shadow absolute top-1/2 z-[999] w-full max-w-[568px] -translate-y-1/2 rounded-lg bg-white ltr:left-1/2 ltr:-translate-x-1/2 rtl:right-1/2 rtl:translate-x-1/2 dark:bg-gray-900 max-md:w-[90%]">
                            <!-- Header Slot -->
                            <slot
                                name="header"
                                :toggle="toggle"
